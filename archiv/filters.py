...
class EventListFilter(SchrederFilter):
    ...
    ft_search = django_filters.CharFilter(field_name='vector_column', method='search_fulltext')

    def search_fulltext(self, queryset, field_name, value):
        return queryset.filter(vector_column=SearchQuery(value, config='german', search_type='websearch'))
