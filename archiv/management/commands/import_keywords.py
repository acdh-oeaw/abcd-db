...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        klaeren, _ = SkosCollection.objects.get_or_create(pref_label="klären")
        wab, _ = SkosCollection.objects.get_or_create(pref_label="WAB")
        mus_hs, _ = SkosCollection.objects.get_or_create(pref_label="Mus.Hs.")
        detail, _ = SkosCollection.objects.get_or_create(pref_label="detaillieren")
        jahreszahl, _ = SkosCollection.objects.get_or_create(pref_label=". Datum")
        schlagwort, _ = SkosCollection.objects.get_or_create(pref_label="Schlagwort")
